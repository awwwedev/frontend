  ...
  <div class="view-news__container container" v-if="news">
    <nav class="view-news__nav nav">
      <ul class="nav__list">
        ...
        <li class="nav__item"><span class="nav__divider">-</span></li>
        <li class="nav__item"><router-link :to="{name: 'news'}" class="nav__link link">Новости</router-link></li>
        <li class="nav__item"><span class="nav__divider">-</span></li>
        <li class="nav__item" v-if="news"><a class="nav__link link link_disabled">{{ news.header }}</a></li>
      </ul>
    </nav>
